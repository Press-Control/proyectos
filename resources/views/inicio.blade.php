              ...
              <div class="row">
                <div class="col-md-12 text-left">
                 <div class="slider">
                    ...
                    <p class="text-black mt-20 mb-30 animated5">Best Watches available on the cheapest prices at Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
    ...
    <div class="container">
     ...
     <div class="col-lg-3 col-sm-6 sm-mb-30">
      <div class="feature-text left-icon">
        ...
        <div class="feature-info">
          <h6 class="pt-15 text-white">Receive Gift cards</h6>
        </div>
      </div>
     </div>
